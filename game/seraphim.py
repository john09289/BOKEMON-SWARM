...
def create_moves() -> dict:
    return {
        ...
        # Trump / Barron moves
        'executive_order': Move('Executive Order', 80, 20, 'Normal',
            'Bans enemy from using status moves for 3 turns'),
        'tweet_storm': Move('Tweet Storm', 70, 16, 'Electric',
            'Confuses target with rapid-fire text'),
        'golden_shower': Move('Golden Shower', 60, 14, 'Light',
            'Rains gold coins; lowers enemy defense'),
        'tower_slam': Move('Tower Slam', 95, 24, 'Fighting',
            'Physical slam from Trump Tower height'),
        'red_pill': Move('Red Pill', 0, 10, 'Psychic',
            'Cures confusion and raises ally attack sharply'),
        'blue_hat': Move('Blue Hat', 0, 8, 'Normal',
            'Raises ally defense and grants immunity to confusion'),
        'maga_punch': Move('MAGA Punch', 75, 16, 'Fighting',
            'Patriotic uppercut; power doubles if ally is fainted'),
        'barron_glare': Move('Barron Glare', 65, 12, 'Dark',
            'Cold stare that lowers enemy speed sharply'),
        'silicon_valley': Move('Silicon Valley', 85, 20, 'Electric',
            'Tech-bro zap; ignores type resistances'),
        'deal_or_no_deal': Move('Deal or No Deal', 0, 12, 'Dark',
            'Randomly swaps HP with enemy (high risk)'),
        # World Sports & Cultures moves
        'samba_beat': Move('Samba Beat', 70, 14, 'Fighting',
            'Rhythmic kick that hits twice'),
        'tango_trap': Move('Tango Trap', 60, 12, 'Dark',
            'Lures enemy into a passionate trap'),
        'flamenco_fury': Move('Flamenco Fury', 80, 18, 'Fire',
            'Dance of fire and passion'),
        'capoeira_whirl': Move('Capoeira Whirl', 75, 16, 'Fighting',
            'Acrobatic spinning kick'),
        'sumo_stomp': Move('Sumo Stomp', 90, 22, 'Ground',
            'Devastating stomp; may cause flinch'),
        'kung_fu_fist': Move('Kung Fu Fist', 85, 18, 'Fighting',
            'Precision strike; always hits'),
        'muay_thai_knee': Move('Muay Thai Knee', 80, 16, 'Fighting',
            'Rising knee strike'),
        'boxing_combo': Move('Boxing Combo', 70, 14, 'Fighting',
            '2-3 hit jab-cross-hook'),
        'wrestling_slam': Move('Wrestling Slam', 85, 18, 'Fighting',
            'Powerbomb from the top rope'),
        'judo_throw': Move('Judo Throw', 75, 16, 'Fighting',
            'Leverage-based throw; damage scales with enemy weight'),
        'mma_spin': Move('MMA Spin', 80, 18, 'Fighting',
            'Spinning backfist; critical hit chance +30%'),
        'ballet_grace': Move('Ballet Grace', 0, 8, 'Fairy',
            'Raises ally evasion and grace for 3 turns'),
        'hip_hop_flow': Move('Hip-Hop Flow', 65, 12, 'Normal',
            'Rhyme-based distraction; lowers enemy accuracy'),
        'reggae_vibe': Move('Reggae Vibe', 0, 10, 'Grass',
            'Heals party and removes status effects'),
        'country_strum': Move('Country Strum', 60, 10, 'Normal',
            'Acoustic attack; super effective against Dark'),
        'metal_scream': Move('Metal Scream', 85, 18, 'Dark',
            'Sonic scream; may cause confusion'),
        'jazz_solo': Move('Jazz Solo', 70, 14, 'Psychic',
            'Improvised solo; power varies randomly'),
        'classical_fury': Move('Classical Fury', 80, 16, 'Psychic',
            'Orchestral crescendo; power increases each turn'),
        'disco_fever': Move('Disco Fever', 75, 14, 'Fire',
            'Dance-floor fire; hits all enemies'),
        'punk_rage': Move('Punk Rage', 70, 12, 'Dark',
            'Anarchic attack; user takes recoil'),
        # Johnny Elbows / Meme Factory moves
        'elbow_drop': Move('Elbow Drop', 80, 16, 'Fighting',
            'High-flying elbow from the top rope'),
        'meme_blast': Move('Meme Blast', 70, 14, 'Psychic',
            'Launches viral meme; confuses target'),
        'viral_spread': Move('Viral Spread', 0, 10, 'Dark',
            'Spreads meme to all enemies; lowers their attack'),
        'factory_reset': Move('Factory Reset', 0, 12, 'Electric',
            'Resets enemy stats to base values'),
        'deep_fry': Move('Deep Fry', 65, 12, 'Fire',
            'Over-saturates target; lowers accuracy'),
        'repost_strike': Move('Repost Strike', 75, 14, 'Psychic',
            'Amplifies previous move damage by 50%'),
        'shadow_ban': Move('Shadow Ban', 0, 10, 'Dark',
            'Removes enemy buffs and prevents new ones for 2 turns'),
        'algorithm_rage': Move('Algorithm Rage', 85, 18, 'Electric',
            'Forced engagement; power increases with each hit'),
        'influencer_pout': Move('Influencer Pout', 50, 8, 'Fairy',
            'Cute but damaging; lowers enemy attack'),
        'cancelled': Move('Cancelled', 0, 8, 'Dark',
            'Target cannot move next turn (social exile)'),
        # Bokeball NBA Jam moves
        'slam_dunk': Move('Slam Dunk', 90, 20, 'Flying',
            'Powerful dunk from the free-throw line'),
        'three_pointer': Move('Three Pointer', 75, 14, 'Psychic',
            'Long-range shot; never misses'),
        'alley_oop': Move('Alley-Oop', 70, 12, 'Flying',
            'Assisted dunk; power doubles with ally'),
        'crossover': Move('Crossover', 60, 10, 'Normal',
            'Dribble move; raises user speed'),
        'block': Move('Block', 0, 8, 'Steel',
            'Blocks next physical attack completely'),
        'steal': Move('Steal', 55, 10, 'Dark',
            'Pickpocket move; may steal held item'),
        'fast_break': Move('Fast Break', 80, 16, 'Normal',
            'Rush attack; power increases with speed'),
        'buzzer_beater': Move('Buzzer Beater', 100, 24, 'Psychic',
            'Last-second shot; power doubles if HP < 25%'),
        # Hypebeast Bazaar moves
        'resell': Move('Resell', 65, 12, 'Dark',
            'Buys low, sells high; drains enemy HP for profit'),
        'limited_drop': Move('Limited Drop', 75, 14, 'Psychic',
            'Releases exclusive item; confuses target'),
        'hype_train': Move('Hype Train', 80, 16, 'Normal',
            'Builds momentum; power increases each turn'),
        'grail_hunt': Move('Grail Hunt', 70, 14, 'Psychic',
            'Searches for rare item; may find random boost'),
        'restock': Move('Restock', 0, 10, 'Normal',
            'Refills user HP and cures status'),
        'copped': Move('Copped', 0, 8, 'Steel',
            'Grants immunity to status for 3 turns'),
        # MAGA Arena moves
        'rally_cry': Move('Rally Cry', 0, 10, 'Normal',
            'Raises all ally stats sharply'),
        'patriotic_fire': Move('Patriotic Fire', 80, 16, 'Fire',
            'Burns with red, white and blue flames'),
        'freedom_fist': Move('Freedom Fist', 85, 18, 'Fighting',
            'Liberty punch; power increases with patriotism'),
        'election_day': Move('Election Day', 70, 14, 'Psychic',
            'Polls enemy; reveals their next move'),
        'veto_power': Move('Veto Power', 0, 10, 'Steel',
            'Nullifies enemy move completely'),
        'state_union': Move('State of the Union', 0, 12, 'Normal',
            'Heals all allies and removes debuffs'),
        'executive_time': Move('Executive Time', 0, 8, 'Psychic',
            'Raises user attack and speed for 3 turns'),
        # Heidi moves
...
def create_seraphim_roster() -> dict:
    ...
    return {
        ...
        'TRUMP': Seraphim(
            ...
            attack=110,
            defense=90,
            moves=[moves['executive_order'], moves['tweet_storm'], moves['golden_shower'], moves['tower_slam'], moves['red_pill']]
        ),
        'BARRON': Seraphim(
            name='BARRON',
            element1='Normal',
            ...
            attack=70,
            defense=65,
            moves=[moves['blue_hat'], moves['maga_punch'], moves['barron_glare'], moves['silicon_valley'], moves['deal_or_no_deal']]
        ),
        # World Sports & Cultures
        'SAMBA QUEEN': Seraphim(
            name='SAMBA QUEEN',
            element1='Fighting',
            element2='Fire',
            level=22,
            ...
            attack=75,
            defense=70,
            moves=[moves['samba_beat'], moves['tango_trap'], moves['flamenco_fury']]
        ),
        'CAPOEIRA MASTER': Seraphim(
            name='CAPOEIRA MASTER',
            element1='Fighting',
            element2='Grass',
            level=24,
            max_hp=100,
            attack=80,
            defense=75,
            moves=[moves['capoeira_whirl'], moves['sumo_stomp'], moves['kung_fu_fist']]
        ),
        'SUMO CHAMPION': Seraphim(
            name='SUMO CHAMPION',
            element1='Ground',
            element2='Fighting',
            level=28,
            ...
            attack=100,
            defense=95,
            moves=[moves['sumo_stomp'], moves['muay_thai_knee'], moves['wrestling_slam']]
        ),
        'KUNG FU MASTER': Seraphim(
            name='KUNG FU MASTER',
            element1='Fighting',
            element2='Psychic',
            level=26,
            ...
            attack=90,
            defense=80,
            moves=[moves['kung_fu_fist'], moves['judo_throw'], moves['mma_spin']]
        ),
        'BALLET DIVA': Seraphim(
            name='BALLET DIVA',
            element1='Fairy',
            element2='Psychic',
            level=20,
            ...
            attack=60,
            defense=75,
            moves=[moves['ballet_grace'], moves['hip_hop_flow'], moves['reggae_vibe']]
        ),
        'HIP HOP LEGEND': Seraphim(
            name='HIP HOP LEGEND',
            element1='Normal',
            element2='Dark',
            level=23,
            ...
            attack=78,
            defense=70,
            moves=[moves['hip_hop_flow'], moves['country_strum'], moves['metal_scream']]
        ),
        'METALHEAD': Seraphim(
            name='METALHEAD',
            element1='Dark',
            ...
            attack=85,
            defense=75,
            moves=[moves['metal_scream'], moves['punk_rage'], moves['jazz_solo']]
        ),
        'DISCO KING': Seraphim(
            name='DISCO KING',
            element1='Fire',
            ...
            attack=72,
            defense=68,
            moves=[moves['disco_fever'], moves['classical_fury'], moves['jazz_solo']]
        ),
        # Johnny Elbows / Meme Factory
        'JOHNNY ELBOWS': Seraphim(
            name='JOHNNY ELBOWS',
            element1='Fighting',
            element2='Dark',
            level=30,
            ...
            attack=95,
            defense=80,
            moves=[moves['elbow_drop'], moves['meme_blast'], moves['viral_spread'], moves['factory_reset'], moves['deep_fry']]
        ),
        'MEME LORD': Seraphim(
            name='MEME LORD',
            element1='Psychic',
            ...
            attack=85,
            defense=75,
            moves=[moves['repost_strike'], moves['shadow_ban'], moves['algorithm_rage'], moves['influencer_pout'], moves['cancelled']]
        ),
        # Bokeball NBA Jam
        'BOKEBALL MVP': Seraphim(
            name='BOKEBALL MVP',
            element1='Flying',
            element2='Psychic',
            level=32,
            ...
            attack=95,
            defense=85,
            moves=[moves['slam_dunk'], moves['three_pointer'], moves['alley_oop'], moves['crossover'], moves['block']]
        ),
        'POINT GUARD': Seraphim(
            name='POINT GUARD',
            element1='Psychic',
            element2='Normal',
            level=24,
            ...
            attack=70,
            defense=65,
            moves=[moves['crossover'], moves['steal'], moves['fast_break'], moves['three_pointer']]
        ),
        'CENTER': Seraphim(
            name='CENTER',
            element1='Steel',
            ...
            attack=90,
            defense=100,
            moves=[moves['block'], moves['slam_dunk'], moves['wrestling_slam'], moves['buzzer_beater']]
        ),
        # Hypebeast Bazaar
        'HYPEBEAST DEALER': Seraphim(
            name='HYPEBEAST DEALER',
            element1='Dark',
            element2='Steel',
            level=26,
            max_hp=100,
            attack=80,
            defense=85,
            moves=[moves['resell'], moves['limited_drop'], moves['hype_train'], moves['grail_hunt'], moves['restock']]
        ),
        'GRAIL HUNTER': Seraphim(
            name='GRAIL HUNTER',
            element1='Psychic',
            element2='Normal',
            level=23,
            ...
            attack=75,
            defense=70,
            moves=[moves['grail_hunt'], moves['copped'], moves['resell'], moves['hype_train']]
        ),
        # MAGA Arena
        'MAGA CHAMPION': Seraphim(
            name='MAGA CHAMPION',
            element1='Normal',
            element2='Fire',
            level=33,
            ...
            attack=100,
            defense=90,
            moves=[moves['rally_cry'], moves['patriotic_fire'], moves['freedom_fist'], moves['election_day'], moves['veto_power']]
        ),
        'PATRIOT': Seraphim(
            name='PATRIOT',
            element1='Normal',
            ...
            attack=65,
            defense=75,
            moves=[moves['state_union'], moves['executive_time'], moves['rally_cry'], moves['freedom_fist']]
        ),
    }
